...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = BOOT_LOGO MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
...
CUSTOM_MODEM = k6302q2gs-LWTG_R2_6763-3M-G4W18F1357820-V0.2
...
#---------------------------工厂测试----------------------------------#校准结果信息是否使用0.1来表示，yes：使用0.1表示，no：使用 未校准/已校准，默认为no
